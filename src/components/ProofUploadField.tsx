...
export default function ProofUploadField({
  ...
  return (
    <div className="space-y-2">
      ...
      <label className={`flex cursor-pointer items-center justify-center gap-2 rounded-xl border border-dashed border-slate-300 px-4 py-3 text-sm transition ${disabled ? 'cursor-not-allowed bg-slate-100 text-slate-400' : 'bg-slate-50 text-slate-600 hover:border-slate-400 hover:bg-white'}`}>
